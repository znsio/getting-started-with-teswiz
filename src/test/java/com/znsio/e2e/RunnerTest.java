...
class RunnerTest {
    ...
    void localDefault() {
        ...
        Runner runner = new Runner("./configs/calculator_config.properties", stepDefDir, featuresDir);
    ...
    void localAndroidCalculator() {
        ...
        // System.setProperty("APP_PATH", "./temp/sampleApps/AndroidCalculator.apk");
        Runner runner = new Runner("./configs/calculator_config.properties", stepDefDir, featuresDir);
    ...
    void localAndroidTheApp() {
        ...
        System.setProperty("PLATFORM", Platform.android.name());
        System.setProperty("TAG", "@theapp");
        System.setProperty("CAPS", "caps/theapp_capabilities.json");
        // System.setProperty("APP_PACKAGE_NAME", "com.android2.calculator3");
        // System.setProperty("atd_android_appPackage", "com.android2.calculator3");
        // System.setProperty("APP_PATH", "./temp/sampleApps/AndroidCalculator.apk");
        Runner runner = new Runner("./configs/theapp_config.properties", stepDefDir, featuresDir);
        // runner.printProcessedConfiguration();
    }
    ...
    void localAndroidMultiDevice() {
        ...
        System.setProperty("atd_calculator_capabilities_android_app_local", "./temp/sampleApps/AndroidCalculator.apk");
        Runner runner = new Runner("./configs/calculator_config.properties", stepDefDir, featuresDir);
        // runner.printProcessedConfiguration();
    }
    ...
    void browserStackAndroidCloudTest() {
        ...
        System.setProperty("APP_PATH", "./temp/sampleApps/AndroidCalculator.apk");
        // System.setProperty("TAG", "@login");
        Runner runner = new Runner("./configs/browserStack_config.properties", stepDefDir, featuresDir);
    }
