...
public class AmazonLoginSignUpBL {
    private static final Logger LOGGER = Logger.getLogger(AmazonLoginSignUpBL.class.getName());
    private final TestExecutionContext context;
    private final SoftAssertions softly;
    private final String currentUserPersona;
    private final Platform currentPlatform;

    public AmazonLoginSignUpBL(String userPersona, Platform forPlatform) {
