...
public class AmazonHomeBL {
    ...
    public AmazonHomeBL get() {
        AmazonHomeScreen.get();
        return this;
    }

    public SearchResultsListBL searchForTheProduct(String productName) {
        AmazonHomeScreen.get().searchForProduct(productName);
        return new SearchResultsListBL();
    }
}
