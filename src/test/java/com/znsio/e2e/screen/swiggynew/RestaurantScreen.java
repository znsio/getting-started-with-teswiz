...
import com.znsio.e2e.screen.swiggynew.web.RestaurantScreenWeb;
...
public abstract class RestaurantScreen {
    ...
    public abstract RestaurantScreen addRandomItemToCart();

    public abstract String getFoodItemNameToBeAdded();

    public abstract int getFoodItemOrderCount();

    public abstract RestaurantScreen decrementCartValueFromProfileSection(int itemsAlreadyAdded);
