...
public class CartSectionInRestaurantScreenWeb extends CartSectionInRestaurantScreen {

        private final Logger LOGGER = Logger.getLogger(CartSectionInRestaurantScreenWeb.class.getName());
        private final Driver driver;
        private final Visual visually;
        private final String SCREEN_NAME = CartSectionInRestaurantScreenWeb.class.getSimpleName();
        ...
        public CartSectionInRestaurantScreenWeb(Driver driver, Visual visually) {
            this.driver = driver;
