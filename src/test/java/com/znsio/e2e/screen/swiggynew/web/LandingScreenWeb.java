...
public class LandingScreenWeb extends LandingScreen {
    ...
    public LandingScreenWeb(Driver driver, Visual visually) {
            ...
            visually.takeScreenshot(SCREEN_NAME, "Swiggy Landing screen");
        }

        @Override
        public RestaurantListScreen searchForDeliveryLocation(String deliveryLoc) {
            ...
            return RestaurantListScreen.get();
        }
