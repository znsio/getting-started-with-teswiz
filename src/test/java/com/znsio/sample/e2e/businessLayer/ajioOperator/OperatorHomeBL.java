...
public class OperatorHomeBL {
    private static final Logger LOGGER = Logger.getLogger(OperatorHomeBL.class.getName());
    private final TestExecutionContext context;
    private final SoftAssertions softly;
    private final String currentUserPersona;
    private final Platform currentPlatform;

    public OperatorHomeBL(String userPersona, Platform forPlatform) {
