package com.znsio.sample.e2e.businessLayer.interactiveCalculatorCLI;
...
public class InteractiveCalculatorCLIBL {
    ...
    public InteractiveCalculatorCLIBL launchInteractiveCLIForCalculator() {
        context.addTestState(SAMPLE_TEST_CONTEXT.CLI_COMMAND_NUMBER, 1);
        AsyncCommandLineExecutor asyncCommandLineExecutor = new AsyncCommandLineExecutor();
        context.addTestState(SAMPLE_TEST_CONTEXT.ASYNC_COMMAND_LINE_EXECUTOR, asyncCommandLineExecutor);
    ...
    private InteractiveCalculatorCLIBL closeTheAsyncCommandLineExecutor() {
        ...
        AsyncCommandLineExecutor asyncCommandLineExecutor = (AsyncCommandLineExecutor) context.getTestState(SAMPLE_TEST_CONTEXT.ASYNC_COMMAND_LINE_EXECUTOR);
    ...
    private void updateCurrentCommandNumber() {
        int commmandNumber = (int) context.getTestState(SAMPLE_TEST_CONTEXT.CLI_COMMAND_NUMBER);
        LOGGER.info("Running command # " + commmandNumber++);
        context.addTestState(SAMPLE_TEST_CONTEXT.CLI_COMMAND_NUMBER, commmandNumber);
    }
}
