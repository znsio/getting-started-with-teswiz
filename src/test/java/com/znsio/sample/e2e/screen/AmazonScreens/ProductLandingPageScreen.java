...
import com.znsio.sample.e2e.screen.AmazonScreens.AmazonWeb.ProductLandingPageScreenWeb;
...
public abstract class ProductLandingPageScreen {
    ...
    public abstract boolean isProdDetailsAndTitleCorrect(String firstProductTitle, String firstProductPrice);
