...
public abstract class AjioCartScreen {
    ...
    public abstract AjioCartScreen addCoupon();

    public abstract boolean verifyCouponApplied();

    public abstract double getCouponSavings();

    public abstract String getProductNameInCart();

    public abstract String getProductSizeInCart() ;
}