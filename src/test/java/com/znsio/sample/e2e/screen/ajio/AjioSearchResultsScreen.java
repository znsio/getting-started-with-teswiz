...
public abstract class AjioSearchResultsScreen {
    ...
    public abstract String getActualGenderFilter();

    public abstract AjioSearchResultsScreen applyFilterForGender(String gender);

    public abstract AjioSearchResultsScreen applyFilterForSize(String size);

    public abstract String getActualSizeFilter();

    public abstract ProductDetailsScreen selectProduct(int productNumber);
}
