...
import com.znsio.sample.e2e.screen.web.ajioShopping.ProductListPageScreenWeb;
...
public abstract class ProductListPageScreen {
    ...
    public abstract ProductLandingPageScreen selectProduct(int productPosition);
}
