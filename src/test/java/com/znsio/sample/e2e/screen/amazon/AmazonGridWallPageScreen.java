...
public abstract class AmazonGridWallPageScreen {
    private static final String SCREEN_NAME = AmazonGridWallPageScreen.class.getSimpleName();
    private static final Logger LOGGER = Logger.getLogger(SCREEN_NAME);
    public static AmazonGridWallPageScreen get() {
        ...
        switch(platform) {
            case web:
                return new AmazonGridWallPageWeb(driver, visually);
        }
        throw new NotImplementedException(SCREEN_NAME + " is not implemented in " + Runner.platform);
    }

    public abstract Boolean checkForResultsHeader();
