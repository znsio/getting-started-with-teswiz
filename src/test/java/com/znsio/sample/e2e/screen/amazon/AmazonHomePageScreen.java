...
import com.znsio.sample.e2e.screen.amazon.web.AmazonHomePageWeb;
...
public abstract class AmazonHomePageScreen {
    ...
    public static AmazonHomePageScreen get() {
        ...
        switch(platform) {
            case web:
                return new AmazonHomePageWeb(driver, visually);
        }
        throw new NotImplementedException(SCREEN_NAME + " is not implemented in " + Runner.platform);
    }

    public abstract GridWallPageBL searchProduct(String productToSearch);
}
