...
public abstract class AmazonProductDetailsScreen {
    private static final String SCREEN_NAME = AmazonProductDetailsScreen.class.getSimpleName();
    private static final Logger LOGGER = Logger.getLogger(SCREEN_NAME);

    public static AmazonProductDetailsScreen get() {
...
//                return new AjioHomeScreenAndroid(driver, visually);
    ...
    public abstract String getActualItemName();
    ...
    public abstract AmazonCartScreen goToCartPage();
}
