...
import com.znsio.sample.e2e.screen.android.amazon.AmazonProductScreenAndroid;
...
public abstract class AmazonProductScreen {
    ...
    public abstract String getProductNameInProductScreen();

    public abstract AmazonProductScreen click_AddToCart_Button() ;
