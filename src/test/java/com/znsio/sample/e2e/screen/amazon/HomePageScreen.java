...
import com.znsio.sample.e2e.screen.web.amazon.HomePageScreenWeb;
...
public abstract class HomePageScreen {
    ...
    public abstract boolean isHomePageLoaded();

    public abstract SearchPageScreen searchProduct(String productName);
