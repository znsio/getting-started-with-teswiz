...
import com.znsio.sample.e2e.screen.amazon.web.ProductDetailsWeb;
...
public abstract class ProductDetailsScreen {
    ...
    public static ProductDetailsScreen get() {
        ...
        switch (platform) {
            case web:
                return new ProductDetailsWeb(driver, visually);
            default:
    ...
    public abstract ShoppingCartScreen clickViewCartButton();

    public abstract ProductDetailsScreen clickAddToCardButton();
}
