...
public abstract class ProductPageScreen {
    ...
    public abstract ProductPageScreen waitTillProductPageIsDisplayed();

    public abstract PopupCartPageScreen addProductToCart();

    public abstract int getNumberOfProductsInCart();
