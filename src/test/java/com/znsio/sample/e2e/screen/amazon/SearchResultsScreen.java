...
public abstract class SearchResultsScreen {
    ...
    public abstract String getTitleOfFirstProduct();

    public abstract boolean isSearchedResultsDisplayed(String product);

    public abstract ProductDetailsScreen userSelectsFirstProduct();
}
