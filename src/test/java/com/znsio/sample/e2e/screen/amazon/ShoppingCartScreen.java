...
import com.znsio.sample.e2e.screen.web.amazon.ShoppingCartScreenWeb;
...
public abstract class ShoppingCartScreen {
    ...
    public abstract String getAddedProductTitleFromShoppingCartScreen(String productTitle);
}
