...
public class HomeScreenAndroid extends HomeScreen {
        ...
        private static final By byStartSearchBoxId = By.id("llpsTvSearch");
        private static final By bySearchFieldId = By.id("searchETV");
        private static final By byStartSearchId = By.id("search_image");
