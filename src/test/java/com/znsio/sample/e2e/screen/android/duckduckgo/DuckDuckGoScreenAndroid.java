package com.znsio.sample.e2e.screen.android.duckduckgo;

import com.znsio.sample.e2e.screen.duckduckgo.DuckDuckGoScreen;
...
public class DuckDuckGoScreenAndroid
    ...
    public DuckDuckGoScreen launchBrowser() {
        WebElement ctaElement = driver.waitTillElementIsPresent(byPrimaryCtaId);
    ...
    public DuckDuckGoScreen cancelChangingDefaultBrowserPopup() {
        driver.waitTillElementIsPresent(byCancelChangingDefaultBrowserId).click();
        return this;
    }
