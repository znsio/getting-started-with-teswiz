...
public abstract class GiftVoucherScreen {
    ...
    public abstract List<Integer> getFinalAmountOfGiftCard();

    public abstract String getErrorMessage();

    public abstract PaymentPageScreen fillTheSenderDetailsAndProceedToPaymentPage(TestExecutionContext context);
}
