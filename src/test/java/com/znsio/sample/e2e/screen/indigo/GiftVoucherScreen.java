...
public abstract class GiftVoucherScreen {
    ...
    public static GiftVoucherScreenWeb get() {
    ...
    public abstract GiftVoucherScreen configureVoucher(String quantity, String amount);
    public abstract GiftVoucherScreen personaliseGiftVoucher(Map senderDerails);

    public abstract boolean previewVoucher();
