...
import com.znsio.sample.e2e.screen.indigo.android.HomeScreenAndroid;
import com.znsio.sample.e2e.screen.indigo.web.HomeScreenWeb;
...
public abstract class HomeScreen {
    ...
    public abstract GiftVoucherScreen navigateToGiftVouchers();
