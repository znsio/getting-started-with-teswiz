...
import com.znsio.sample.e2e.screen.android.indigo.GiftVoucherScreenAndroid;
import com.znsio.sample.e2e.screen.android.indigo.PaymentScreenAndroid;
import com.znsio.sample.e2e.screen.web.GiftVoucherScreenWeb;
...
public abstract class PaymentScreen {
    ...
    public abstract String getPaymentPageHeading();
    public abstract PaymentScreen getPaymentAmount();
}
