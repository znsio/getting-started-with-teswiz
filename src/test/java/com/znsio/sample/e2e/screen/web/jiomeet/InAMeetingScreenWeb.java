...
public class InAMeetingScreenWeb
    ...
    private final By byCurrentMeetingNumberXpath = By.xpath(
            "//div[text()='Meeting ID']/following-sibling::div");
    private final By byCurrentMeetingPinXpath = By.xpath(
            "//div[text()='Password']/following-sibling::div");
    private final By byCurrentMeetingInvitationLinkXpath = By.xpath(
