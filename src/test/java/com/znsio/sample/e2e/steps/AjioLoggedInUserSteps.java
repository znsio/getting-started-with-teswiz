...
import com.znsio.sample.e2e.businessLayer.ajioEAT.AjioSearchBL;
import com.znsio.sample.e2e.businessLayer.ajioEAT.AjioLoginBL;
...
public class AjioLoggedInUserSteps {
    ...
    public void iLoginToAjioAs(String user) {
        ...
        new AjioLoginBL(SAMPLE_TEST_CONTEXT.LOGGEDIN_USER, Runner.getPlatform()).loginAsValidUser(userDetails);
    }
