...
public class AjioSteps {
    ...
    public void iAGuestUserSearchForProducts(String product) {
        LOGGER.info(String.format("iAGuestUserSearchForProducts - Persona:'%s', Platform: '%s'", SAMPLE_TEST_CONTEXT.ME, Runner.platform));
    ...
    public void iApplyFiltersForGenderWithSize(String gender, String size) {
        LOGGER.info(String.format("iApplyFiltersForGenderWithSize"));
        new ResultsBL().refineProducts(gender, size);
    }
    ...
    public void iSelectAndAddThe1stProductWithTheRightSizeToTheBag() {
        LOGGER.info(String.format("iSelectAndAddThe1stProductWithTheRightSizeToTheBag"));
        new ResultsBL().selectProduct().addProductToCart();
    }

    @Then("I can apply a coupon from the bag")
    public void iCanApplyACouponFromTheBag() {
        LOGGER.info(String.format("iCanApplyACouponFromTheBag"));
