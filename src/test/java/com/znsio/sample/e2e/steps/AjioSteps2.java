...
import com.znsio.sample.e2e.businessLayer.ajio.AjioSearchBL2;
...
public class AjioSteps2 {
    ...
    public void iAGuestUserSearchForProducts(String product) {
        ...
        new AjioSearchBL2(SAMPLE_TEST_CONTEXT.GUEST_USER, Runner.platform).searchFor(product);
    }

    @And("I apply filters for gender {string} with size {string}")
    public void iApplyFiltersForGenderWithSize(String string, String string2) {
