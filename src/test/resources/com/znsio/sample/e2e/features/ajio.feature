...
#  CONFIG=./configs/ajio_local_config2.properties TAG="@ajio" PLATFORM=web ./gradlew run
#  CONFIG=./configs/ajio_local_config2.properties TAG="@ajio" PLATFORM=android ./gradlew run
